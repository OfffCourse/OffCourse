...
<style>
    .main-content {
        font-size: 2rem; !important;/* 기본보다 크게 */
    }
    ...
    <aside class="sidebar">
        ...
        <div class="filter-group">
            ...
            <div class="filter-options">
                <div class="filter-option">
                    ...
                    <label for="prog">백엔드</label>
                </div>
                <div class="filter-option">
                    <input type="checkbox" id="frontend">
                    <label for="design">프론트엔드</label>
                </div>
                <div class="filter-option">
        ...
        <div class="filter-group">
            ...
            <div class="price-range">
                <input type="number" class="price-input" placeholder="최소" min="0">
                <span>~</span>
                <input type="number" class="price-input" placeholder="최대" min="0">
            </div>
        </div>
        ...
        <div class="filter-group">
            ...
            <div class="filter-options">
                ...
                <div class="filter-option">
                    ...
                    <label for="star4">⭐⭐⭐⭐ 이상</label>
                </div>
                <div class="filter-option">
                    <input type="checkbox" id="star3">
                    <label for="star3">⭐⭐⭐ 이상</label>
                </div>
                <div class="filter-option">
                    <input type="checkbox" id="star2">
                    <label for="star2">⭐⭐ 이상</label>
                </div>
    ...
    <main class="main-content">
        <div class="results-header">
            ...
            <div class="sort-buttons">
                <button class="sort-btn" data-sort="default">최신순</button>
                        ...
                        <div class="course-content">
                            ...
                            <div class="course-schedule">
                                <div class="schedule-row">
                                    ...
                                    <span class="schedule-value">${c.courseStartDate}</span>
                                </div>
                                <div class="schedule-row">
                            ...
                            <div class="course-footer">
                                <div class="course-price">
                                    ...
                                    <span class="price-current">
                                        <fmt:formatNumber value="${c.coursePrice * (1 - c.courseDiscount / 100.0)}" type="number" maxFractionDigits="0"/>원
                                    </span>
                                </div>
...
<script>
    $(document).ready(function () {
        $('.sort-btn').on('click', function () {
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/course/sort',
                type: 'GET',
                data: { sort: sortType },
