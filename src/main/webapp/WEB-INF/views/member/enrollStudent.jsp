📄 /WEB-INF/views/member/enrollStudent.jsp
...
<div style="margin-top: 100px; max-width: 700px; margin: auto; padding: 20px;">
 ...
 <form action="${path}/member/enroll" method="post" enctype="multipart/form-data" id="studentEnrollForm">
    ...
    <div class="form-group">
      <label>비밀번호 확인</label>
      <div style="position:relative;">
        <input type="password" class="form-control" id="studentConfirmPwd" required>
...
<script>
  ...
  // ✅ togglePassword 두 번째 인자 추가로 아이콘도 바뀌게
  ...
  // ✅ 비밀번호 확인 입력 시 확인 로직 (ID 오류 수정)
  document.getElementById("studentConfirmPwd").addEventListener("input", function () {
    const pwd = document.getElementById("password").value; // ✅ 수정됨
