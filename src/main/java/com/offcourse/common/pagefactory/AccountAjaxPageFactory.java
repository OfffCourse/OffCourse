...
public class AccountAjaxPageFactory {
    public static String basicPageBar(int cPage, int numPerPage, int totalData, String jsFunctionName, String statusParam) {
        ...
        if (pageNo == 1) {
            ...
            sb.append("<li class='page-item'>")
                    .append("<a class='page-link' data-page='").append(pageNo - 1).append("' href='javascript:")
                    .append(jsFunctionName).append("(\"").append(statusParam).append("\", ").append(pageNo - 1).append(")'>이전</a></li>");
        }

        while (!(pageNo > pageEnd || pageNo > totalPage)) {
            if (pageNo == cPage) {
                sb.append("<li class='page-item active'><a class='page-link' data-page='").append(pageNo).append("'>").append(pageNo).append("</a></li>");
            } else {
                sb.append("<li class='page-item'>")
                        .append("<a class='page-link' data-page='").append(pageNo).append("' href='javascript:")
